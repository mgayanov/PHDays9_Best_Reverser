...
Нужно узнать, где начинается проверка. Чтобы выяснить это, поставим брейк на инструкцию 0x000017F6 `move.l a0,-(sp)`.
Пртому что именно сюда мы попадаем, если длина ключа будет правильной.
