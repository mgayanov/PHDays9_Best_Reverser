...
Эта конструкция выдает адрес, куда сохранять d2 сейчас содержит входной аргумент
...
Регистр a2 хранит значение 0xFF0D46, a2 + 0x24 = 0xFF0D6A - это место, где хранится предыдущий результат функции(показано ниже)
d0 = *(a2 + 0x24)
d2 = d0 ^ d2
d2 = d2 & 0xFF
d2 = d2 + d2
